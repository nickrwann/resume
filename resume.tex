...
% Patents and Innovations Section
\begin{minipage}[t]{1\textwidth}
    ...
    % Innovation 1
    \runsubsection{Dynamic Wireless Network Optimization}
    \descript{}
    ...
    % Innovation 2
    \runsubsection{Intelligent Network Resource Allocation}
    \descript{}
    ...
    % Innovation 3
    \runsubsection{Wi-Fi Cluster Management for Dense Networks}
    \descript{}
    ...
    % Innovation 4
    \runsubsection{Wi-Fi Spatial Density Management for Ad-Hoc Networks}
    \descript{}
    ...
    % Innovation 5
    \runsubsection{Touchpad Design with Illuminated Collaboration Buttons}
    \descript{}
    ...
    % Innovation 6
    \runsubsection{Collaboration Touchpad with Interactive Controls}
    \descript{}
